<template>
  <v-container>
    ...
    <v-row
      v-if="
        selectedChart != '' &&
        (firstSelectedVersion == '' || secondSelectedVersion == '')
      "
      class="d-flex flex-row-reverse"
    >
      <v-alert outlined dense type="warning" text>
...
export default {
  ...
  methods: {
    ...
    async fetchFirstChartDetail() {
      ...
      const firstChart = await api.fetchChart(
        this.selectedRepo,
        this.selectedChart,
    ...
    async fetchSecondChartDetail() {
      ...
      this.progressing = true;
      const secondChart = await api.fetchChart(
        this.selectedRepo,
        this.selectedChart,
